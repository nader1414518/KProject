...
public class Collectable : MonoBehaviour
{
    ...
    private void Swim()
    {
        ...
        // Else, swim towards the destination 
        if (Time.fixedTime >= nextActionTime)
        {
            // Randomize the speed 
            randomizedSpeed = collectableSpeed * Random.Range(0.5f, 1.5f);
        ...
        {
            // make sure small ball does not swim past the target
